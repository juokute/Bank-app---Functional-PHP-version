...
<body>
    <div class="container-create">
        ...
        <form onsubmit="createAccount(event)">
            ...
            <input class="input-create" type="text" required />

            <label class="label-create">Last Name</label>
            <input class="input-create" type="text" required />

            <label class="label-create">Account Number</label>
            <input class="input-create" type="text" required placeholder="LTxx xxxx xxxx xxxx xxxx" />

            <label class="label-create">Personal ID</label>
            <input class="input-create" type="text" required />

            <label class="label-create">Initial Balance</label>
            <input class="balance input-create" type="number" value="0.00" readonly />
